...
"""
Inflatable Soft Body Example

Demonstrates inflation of a 3D tetrahedral soft body using the SolverInflatable.
...
Usage:
    ...
    python -m newton.examples.inflatable.example_inflatable --max_pressure 2.5 --cycle_speed 0.02
"""
...
def main():
    parser = argparse.ArgumentParser(description='Inflatable Soft Body Demo')
