...
"""
Shared code for MPM sand + soft/deformable body coupling (inflatable examples).

Used by inflatable-on-sand examples in this folder (inflatable_box_sand, mpm_worm_sand).
Scatter method: for each sand-contact impulse, find the nearest deformable particle
and add the impulse there (atomic). Caller pre-filters impulses to the deformable
collider and launches with dim=collider_count.
"""
