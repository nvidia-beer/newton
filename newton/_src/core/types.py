...
try:
    ...
    # Older or container warp builds may not export DeviceLike (device is typically str | None)
    Devicelike = str | None  # type: ignore[misc, assignment]

try:
    from warp import Device as Device
except ImportError:
    # Older or container warp builds may not export Device (return type of wp.get_device())
