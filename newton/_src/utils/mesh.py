...
def create_box_mesh(half_extents: tuple[float, float, float]) -> Mesh:
    """Create a box mesh. Returns a Mesh with vertices and triangle indices."""
...
def create_sphere_mesh(radius: float, subdivisions: int = 2) -> Mesh:
    ...
    norm_factor = float(np.linalg.norm(verts_list[0]))
    verts_list = [
        [v[0] / norm_factor * radius, v[1] / norm_factor * radius, v[2] / norm_factor * radius]
        for v in verts_list
    ]
    faces = [
...
def create_plane_mesh(width: float, height: float) -> tuple[np.ndarray, np.ndarray]:
    """Create a quad mesh in the xy-plane (z=0). Returns (vertices, indices) as numpy arrays."""
...
def create_capsule_mesh(radius: float, half_height: float, **kwargs) -> Mesh:
    """Create a capsule mesh. Not yet implemented."""
    raise NotImplementedError("create_capsule_mesh is not implemented in this build")


def create_cone_mesh(radius: float, height: float, **kwargs) -> Mesh:
    """Create a cone mesh. Not yet implemented."""
    raise NotImplementedError("create_cone_mesh is not implemented in this build")


def create_cylinder_mesh(radius: float, half_height: float, **kwargs) -> Mesh:
    """Create a cylinder mesh. Not yet implemented."""
    raise NotImplementedError("create_cylinder_mesh is not implemented in this build")


def create_ellipsoid_mesh(radius_x: float, radius_y: float, radius_z: float, **kwargs) -> Mesh:
    """Create an ellipsoid mesh. Not yet implemented."""
    raise NotImplementedError("create_ellipsoid_mesh is not implemented in this build")
