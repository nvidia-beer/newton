...
NEWTON_PATH="$(dirname "$SCRIPT_DIR")"
...
# Detect current architecture if auto
...
case "$PLATFORM" in
    arm64)
        ...
        echo "Using NVIDIA CUDA 13 base image with warp-lang v1.11.0+cu13"
        echo ""
    ...
    both)
        ...
        # Tag the appropriate one as latest based on current architecture
